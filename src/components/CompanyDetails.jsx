  ...
  useEffect(() => {
    ...
    if (isInView) {
      intervalId = setInterval(() => {
        if (count1 < 6000) {
          setCount1((prevCount) => prevCount + 100);
        }
        if (count2 < 7000) {
          setCount2((prevCount) => prevCount + 100);
        }
        if (count1 >= 6000 && count2 >= 7000) {
          ...
          <div className="container ditelses-frost-section">
            <div className="row">
              ...
              <div className="col-md-6 mt-3 info-box">
                ...
                <p style={{ fontSize: "20px", marginBottom: "40px" }}>At The Holidays Club, we take pride in crafting an unparalleled escape where luxury meets nature. Immerse yourself in a world of sophistication and serenity, where every detail is designed to exceed expectations and create an exceptional retreat for our valued guests.</p>

                <div className="box-group  ">
                  <div className="box1 project-done">
                    <h2>{count1}</h2>
                    <span style={{ marginTop: "10px" }}>PROJECT<br></br> COMPELETED </span>
                  </div>
                  <div className="box1 project-done">
                    <h2>{count2}</h2>
                    <span style={{ marginTop: "10px" }}>HAPPY<br></br> CUSTOMERS </span>
                  </div>
                </div>
