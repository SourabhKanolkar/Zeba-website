...
export default function Resorts() {
             ...
             <div className="slide-track d-flex" style={{overflow:"auto"}}>
               ...
               <div className="slick-active" >
                 <div className="img-box-resort">
                   ...
                   <figure className=' resort-page-img' style={{ backgroundImage: "url('https://curlytales.com/wp-content/uploads/2022/10/ssf.jpg')",backgroundSize:"cover",backgroundPosition:"center",width:"270px" }} >
                     {/* <img src="https://static3-clubmahindra.gumlet.io/storage/app/media/All%20Compressed%20banners/Summer-Sands.jpg?w=768&dpr=1.0" alt="resott" className='img-fluid resort-page-img' /> */}
                       <div className="name-location-box">
                       <h3 style={{fontSize:"18px",color:"#fff"}}>Le Vintuna Gangtok</h3>
                       <p className='resort-location-address'>Kodaikanal, Tamil Nadu  </p>
                       </div>
                   </figure>
  ...
  <a href="https://wa.me/8459039060?text=Hello can I help you ?" target='blank' style={{position:"fixed",right:"0",bottom:"0",marginBottom:"20px"}}>
