      ...
      <div className="offcanvas-body">
        <ul className="navbar-nav justify-content-end     flex-grow-1 pe-3">
          ...
          <li className="nav-item">
            ...
            <Link to="/home" className="nav-link" style={{ fontFamily: "sans-serif" }} onClick={handleLinkClick}>BookNow</Link>
          
          </li>
          <li className="nav-item">
            {/* <a className="nav-link" style={{fontFamily:"sans-serif"}} href="/" onClick={handleLinkClick} >Contact</a> */}
