      ...
      <nav className="navbar navbar-expand-lg bg-body-tertiary fixed-top">
        <div className="container">
            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li className="nav-item">
                  <a className="nav-link" aria-current="page" style={{fontFamily:"sans-serif"}} href="#home-page-section" onClick={handleLinkClick}>Home</a>
                </li>
          ...
          <ul className="dropdown-menu">
            ...
            <li>
                 {/* <Link to="/exchange" className="nav-link" style={{ fontFamily: "sans-serif" }} onClick={handleLinkClick}>Exchange</Link> */}
                 <a className='nav-link' href="https://www.7across.com/">Exchange</a>
            </li>
                ...
                <li>   <Link to="/membership" className="nav-link" style={{ fontFamily: "sans-serif" }} onClick={handleLinkClick}>Membership</Link>
            </li>
                {/* <li className="nav-item">
                  <a className="nav-link" style={{fontFamily:"sans-serif"}} href="#footer-section-page" onClick={handleLinkClick}>Contact</a>
                </li> */}
              </ul>
            </div>
          </div>
